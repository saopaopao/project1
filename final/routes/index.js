...
router.get('/isC',function(req,res,next){
	postTip.find({part:"寝室生活"},function(err,response){
		if(req.session.now_user){
			Person.find({name:req.session.now_user.id},function(err,response1){
				var arr = [];
				if(response.length>9){
...
router.get('/isJava',function(req,res,next){
	postTip.find({part:"校园美景"},function(err,response){
		if(req.session.now_user){
			Person.find({name:req.session.now_user.id},function(err,response1){
				var arr = [];
				if(response.length>9){
...
router.get('/isfront',function(req,res,next){
	postTip.find({part:"后勤"},function(err,response){
		if(req.session.now_user){
			Person.find({name:req.session.now_user.id},function(err,response1){
				var arr = [];
				if(response.length>9){
...
router.get('/isend',function(req,res,next){
	postTip.find({part:"教室教学"},function(err,response){
		if(req.session.now_user){
			Person.find({name:req.session.now_user.id},function(err,response1){
				var arr = [];
				if(response.length>9){
...
router.get('/isdata',function(req,res,next){
	postTip.find({part:"学习"},function(err,response){
		if(req.session.now_user){
			Person.find({name:req.session.now_user.id},function(err,response1){
				var arr = [];
				if(response.length>9){
...
router.get('/isArtificial',function(req,res,next){
	postTip.find({part:"毕业就业"},function(err,response){
		if(req.session.now_user){
			Person.find({name:req.session.now_user.id},function(err,response1){
				var arr = [];
				if(response.length>9){
...
router.get('/isFrame',function(req,res,next){
	postTip.find({part:"今日餐食"},function(err,response){
		if(req.session.now_user){
			Person.find({name:req.session.now_user.id},function(err,response1){
				var arr = [];
				if(response.length>9){
...
router.get('/isgame',function(req,res,next){
	postTip.find({part:"校园新闻"},function(err,response){
		if(req.session.now_user){
			Person.find({name:req.session.now_user.id},function(err,response1){
				var arr = [];
				if(response.length>9){
